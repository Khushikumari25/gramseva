...
function getCategoryImage(category) {
  const images = {
    ...
    organic: '/assets/images/turmeric.jpg',
...
function renderFallbackProducts(grid) {
  const fallback = [
    { name: 'Fresh Cow Milk', nameHi: 'ताजा गाय का दूध', category: 'dairy', price: 60, unit: 'litre', location: 'Muzaffarpur, Bihar', images: ['/assets/images/milk.jpg'] },
    ...
    { name: 'Organic Turmeric Powder', nameHi: 'जैविक हल्दी पाउडर', category: 'organic', price: 250, unit: 'kg', location: 'Patna, Bihar', images: ['/assets/images/turmeric.jpg'] },
